...
values.me["strainer"] = "(스트레이너를 이용해) 얼음을 빼고 부어주세요";
values.me["barspoon"] = "바스푼(숟가락)을 이용해 내용물을 잘 저어주세요";
values.me["muddler"] = "머들러(숟가락)를 이용해 내용물을 충분히 으깨주세요";
values.me["sieve"] = "뜰체를 이용해 걸러주세요";
values.me["blender"] = "믹서기로 내용물을 갈아주세요";
